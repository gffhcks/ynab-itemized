...
from ynab_itemized.models.transaction import (
    TransactionItem, YNABTransaction, ItemizedTransaction, TransactionStatus
)
...
class TestItemizedTransaction:
    ...
    def test_validate_totals_success(self, sample_itemized_transaction):
        ...
        sample_itemized_transaction.ynab_transaction.amount = Decimal("25370")  # $25.37 in milliunits
    ...
    def test_validate_totals_failure(self, sample_itemized_transaction):
        ...
        sample_itemized_transaction.ynab_transaction.amount = Decimal("30000")  # $30.00 in milliunits
